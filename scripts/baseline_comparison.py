...
def train_model(model, train_loader, device, num_epochs=10):
    ...
    # Increased learning rate since we're training from scratch
...
def run_few_shot_evaluation(
    features, labels, n_way=5, k_shot=5, n_query=5, n_episodes=100
):
...
def main():
    ...
    model_state = train_model(model, train_loader, device, num_epochs=30)
